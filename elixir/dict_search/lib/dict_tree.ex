defmodule DictTree do
  ...
  def takeNode(key,tree), do: Map.get_lazy(tree,key,fn-> nil end)
  ...
  defp condition(conditionFun,successFun,failureFun)when is_function(conditionFun) and is_function(successFun) and is_function(failureFun) do
